...
export const translations = {
  en: {
    ...
    // Homepage
    'home.hero.title': 'Contemporary Art Space in Khao Yai',
    ...
    // About
    'about.title': 'About Khao Yai Art Forest',
    'about.description': 'Khao Yai Art Forest is a contemporary art space dedicated to fostering dialogue between artists, curators, and the public.',
    ...
    'about.history.content': 'Founded in 2024, Khao Yai Art Forest has quickly become a vital part of Khao Yai\'s contemporary art scene.',
  ...
  th: {
    ...
    // Homepage - Thai
    'home.hero.title': 'พื้นที่ศิลปะร่วมสมัยในเขาใหญ่',
    ...
    'residency.upcomingArtists': 'ศิลปินที่จะมาถึง',
